...
*/
    if (Controller.ButtonL2.pressing()){
        LiftLeft.spin(vex::directionType::fwd,50,vex::velocityUnits::rpm);
        LiftRight.spin(vex::directionType::fwd,50,vex::velocityUnits::rpm);
    }else{
        LiftLeft.stop(vex::brakeType::hold);
        LiftRight.stop(vex::brakeType::hold);
    }
    if (Controller.ButtonR2.pressing()){
        LiftLeft.spin(vex::directionType::rev,50,vex::velocityUnits::rpm);
        LiftRight.spin(vex::directionType::rev,50,vex::velocityUnits::rpm);
    }
    /*  
    ...
    if (Controller.ButtonR1.pressing()){
        ClawMotor.spin(vex::directionType::rev,150,vex::velocityUnits::rpm);
    }
    if (Controller.ButtonL1.pressing()){
        ClawMotor.spin(vex::directionType::fwd,150,vex::velocityUnits::rpm);
    }
