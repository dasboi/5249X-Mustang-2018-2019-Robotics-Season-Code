...
static void liftRamp(){
    ...
    static void raiseArms(){
      LiftMotor1.spinFor(-1080, rotationUnits::deg);
      LiftMotor2.spinFor(-1080, rotationUnits::deg);
    }
    static void dropArms(){
      LiftMotor1.setReversed(true);
      LiftMotor2.setReversed(true);
      LiftMotor1.spinFor(1080, rotationUnits::deg);
      LiftMotor2.spinFor(1080, rotationUnits::deg);
      LiftMotor1.setReversed(false);
      LiftMotor2.setReversed(false);
    }
    ...
    static void turn(int degrees, bool right){
      if(right == true){
        while(ChassisGyro.value(rotationUnits::deg) < degrees){
          LeftMotor.setVelocity(degrees / ChassisGyro.value(rotationUnits::deg), percentUnits::pct);
          RightMotor.setVelocity(degrees / ChassisGyro.value(rotationUnits::deg), percentUnits::pct);

          LeftMotor.spin(directionType::fwd);
          RightMotor.spin(directionType::rev);
        }
        LeftMotor.setVelocity(0, velocityUnits::rpm);
        RightMotor.setVelocity(0, velocityUnits::rpm);
